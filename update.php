...
if (isset($_GET['id'])) {
    if (!empty($_POST)) {
        ...
        // Update the record
        $stmt = $pdo->prepare('UPDATE users SET lastname = ?, name = ?, email = ?, phone = ?, title = ?, createad = ? WHERE id = ?');
...
<div class="content update">
    ...
    <form action="update.php?id=<?=$contact['id']?>" method="post">
        ...
        <input type="datetime-local" name="created" value="<?=date('Y-m-d\TH:i', strtotime($contact['createad']))?>" id="createad">
